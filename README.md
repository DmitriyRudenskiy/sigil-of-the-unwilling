...
- `tools/make_grid.py`: Собирает изображения из директории в грид 4x4 (1024x1024, ячейки 256x256). Если изображений > 16, создает несколько файлов. Пустые ячейки заполняются зеленым хромакеем (#00FF00).
