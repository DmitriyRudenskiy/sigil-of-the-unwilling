...
const WorldPersistenceScript = preload("res://game/world/WorldPersistence.gd")
const ResourceChainServiceScript = preload("res://game/world/ResourceChainService.gd")
const WorldShortcutsScript = preload("res://game/world/WorldShortcuts.gd")
