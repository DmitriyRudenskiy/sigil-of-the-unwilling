extends SceneTree
func _init():
	var c: RefCounted = load("res://scripts/entities/hero/components/hero_stats_component.gd").new()
	var data := {
		"hero_name": "Old",
	...
	var p: RefCounted = load("res://scripts/data/hero_build_profile.gd").new()
