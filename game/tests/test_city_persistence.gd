...
func test_village_name_deterministic() -> void:
	assert_that(_CityFactory.village_name(12345, Vector2i(7, 9))).is_equal(_CityFactory.village_name(12345, Vector2i(7, 9)))
	assert_str(_CityFactory.village_name(12345, Vector2i(7, 9))).is_not_empty()


func test_village_name_differs_by_seed() -> void:
	assert_bool(_CityFactory.village_name(1, Vector2i(5, 5))
		!= _CityFactory.village_name(2, Vector2i(5, 5))).is_true()
