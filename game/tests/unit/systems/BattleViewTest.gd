...
# TASK_09: BattleView — юнит-спрайты, подсветка, курсор.
# Инстанцируем сцену целиком: setup() требует $Terrain/$Highlight/$Cursor/$Camera.
