...
# TASK_09: WorldEventRouter — сигналы героя и маркеры городов.
# Лёгкие стабы вместо реального Hero/Map (router коннектит только сигналы).
...
func test_hero_moved_updates_visibility() -> void:
	# 4.8: ход героя пересчитывает карту видимости
