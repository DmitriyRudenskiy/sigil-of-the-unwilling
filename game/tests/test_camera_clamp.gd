...
func test_clamp_basic() -> void:
	...
	assert_that(_Camera._clamp_val(15.0, 0.0, 10.0)).is_equal(10.0)

func test_clamp_inverted_centers() -> void:
	assert_that(_Camera._clamp_val(0.0, 100.0, 0.0)).is_equal(50.0)
	assert_that(_Camera._clamp_val(999.0, 100.0, 0.0)).is_equal(50.0)
