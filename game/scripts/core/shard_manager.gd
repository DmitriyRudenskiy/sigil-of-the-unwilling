...
const _ShardState = preload("res://scripts/core/shard_state.gd")

static var _instance: ShardManager = null
...
static func instance() -> ShardManager:
	if _instance == null:
		_instance = ShardManager.new()
	return _instance
