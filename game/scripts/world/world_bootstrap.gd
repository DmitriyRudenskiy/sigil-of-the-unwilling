...
const WorldPersistenceScript = preload("res://scripts/world/world_persistence.gd")
const ResourceChainServiceScript = preload("res://scripts/world/resource_chain_service.gd")
const WorldShortcutsScript = preload("res://scripts/world/world_shortcuts.gd")
const EndgameControllerScript = preload("res://scripts/systems/endgame_controller.gd")
const _TerrainResourceManager = preload("res://scripts/data/terrain_resource_manager.gd")
