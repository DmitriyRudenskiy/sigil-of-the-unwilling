...
const CityManagerScript = preload("res://scripts/world/city_manager.gd")
const WorldUIManagerScript = preload("res://scripts/ui/world_ui_manager.gd")
const WorldStateDeltaScript = preload("res://scripts/world/world_state_delta.gd")
const ResourceChainServiceScript = preload("res://scripts/world/resource_chain_service.gd")
const _VisibilityMapScript = preload("res://scripts/core/visibility_map.gd")
const ShardManagerScript = preload("res://scripts/core/shard_manager.gd")
const WorldSaveLoadServiceScript = preload("res://scripts/world/world_save_load_service.gd")
const WorldHeroManagerScript = preload("res://scripts/world/world_hero_manager.gd")
