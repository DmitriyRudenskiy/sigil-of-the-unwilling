...
const CLASSES := {
	"barbarian": {
		...
		"power_source": "Ярость",
		"bonuses": {"attack": 2, "defense": 1, "cha": 1},
	},
	"fighter": {
		"name": "Воитель",
	...
	"monk": {
		...
		"power_source": "Раны",
		"bonuses": {"attack": 1, "knowledge": 1, "wis": 1},
	},
	"paladin": {
		"name": "Паладин",
		"desc": "Священный защитник и целитель.",
		"power_source": "Вера",
		"bonuses": {"defense": 2, "knowledge": 1, "cha": 1},
	},
	"priest": {
		"name": "Священник",
		"desc": "Хранитель чудес и молитв.",
		"power_source": "Вера",
		"bonuses": {"spell_power": 2, "knowledge": 1, "wis": 1},
	},
	"druid": {
		"name": "Друид",
	...
	"cipher": {
		...
		"power_source": "Фокус",
		"bonuses": {"spell_power": 2, "attack": 1, "int": 1},
	},
	"wizard": {
		"name": "Маг",
		"desc": "Исследователь арканных потоков.",
		"power_source": "Аркана",
		"bonuses": {"spell_power": 2, "knowledge": 1, "wis": 1, "int": 1},
	},
	"ranger": {
		"name": "Следопыт",
		"desc": "Стрелок-одиночка дикой окраины.",
		"power_source": "Узел",
		"bonuses": {"attack": 2, "knowledge": 1, "luk": 1},
	},
	"rogue": {
		"name": "Разбойник",
		"desc": "Хитрый убийца из тени.",
		"power_source": "Хитрость",
		"bonuses": {"attack": 1, "knowledge": 1, "luk": 1, "int": 1},
	},
	"chanter": {
		"name": "Напевец",
		"desc": "Поддержка через священные напевы.",
		"power_source": "Фразы",
		"bonuses": {"spell_power": 1, "knowledge": 2, "cha": 1},
	},
}
