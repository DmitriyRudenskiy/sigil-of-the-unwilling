...
const CULTURES := {
	...
	"old_vailia": {"name": "Старая Вайлия", "desc": "Древние города магов.", "bonuses": {"spell_power": 2}},
...
const BACKGROUNDS := {
	...
	"criminal": {"name": "Преступник", "desc": "Знал улицы снизу.", "bonuses": {"attack": 1, "knowledge": 1}},
	...
	"merchant": {"name": "Купец", "desc": "Торговал по всему миру.", "bonuses": {"knowledge": 2}},
}
