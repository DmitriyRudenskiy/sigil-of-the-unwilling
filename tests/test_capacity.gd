...
func test_remove_resource() -> void:
	...
	assert_eq(hero.strategic_resources[&"oak"], 2, "is 2")
...
func test_remove_over_amount() -> void:
	...
	assert_eq(hero.strategic_resources[&"oak"], 0, "is 0")
...
func test_auto_wood_per_day() -> void:
	hero.end_turn()
	assert_eq(hero.strategic_resources[&"wood"], GameSettings.RESOURCE_AUTO_WOOD_PER_DAY, "auto wood")


func test_auto_stone_per_day() -> void:
	hero.end_turn()
	assert_eq(hero.strategic_resources[&"stone"], GameSettings.RESOURCE_AUTO_STONE_PER_DAY, "auto stone")


func test_auto_capped() -> void:
	hero.add_strategic_resource(&"wood", GameSettings.RESOURCE_CAPACITY - 1)
	hero.end_turn()
	assert_eq(hero.strategic_resources[&"wood"], GameSettings.RESOURCE_CAPACITY, "capped auto")
