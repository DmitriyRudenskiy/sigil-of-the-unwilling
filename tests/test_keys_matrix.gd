...
func test_hidden_vs_basic() -> void:
	assert_true(_RR.is_hidden_resource(&"oak"), "oak hidden")
	assert_true(_RR.is_hidden_resource(&"silver"), "silver hidden")
	assert_false(_RR.is_hidden_resource(&"wood"), "wood not hidden")
	assert_false(_RR.is_hidden_resource(&"stone"), "stone not hidden")
