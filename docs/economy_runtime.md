...
которые работают поверх чистой модели города (`city_system.md`): модель ресурсов,
цепочки производства, назначение рабочих, циклический приток последователей и
нарративный слой персонажей.
...
См. [`city_system.md`](city_system.md) — модель `City`, население, ход города,
