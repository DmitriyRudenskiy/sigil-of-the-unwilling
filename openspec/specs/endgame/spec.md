...
# endgame Specification

## Purpose

Терминальные условия партии: состояние игры (RUNNING/VICTORY/DEFEAT) с причиной и sticky-поведением, поражение при смерти героя без преемника или потере всех городов, победа при достижении порога славы (Path completion) или доминации, итоговый экран со сводкой партии и событие `game_ended` для пост-игровых систем.
