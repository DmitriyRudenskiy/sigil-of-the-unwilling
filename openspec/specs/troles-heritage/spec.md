# troles-heritage Specification

## Purpose
Requirements for the ported start screen, hero constructor, and location-aware audio system, including graceful degradation and the relocation of dev/sandbox entries into settings.
