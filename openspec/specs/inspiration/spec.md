# inspiration Specification

## Purpose

Defines the hero's secular core need `inspiration` (replacing the former `belief`), its burnout death on depletion, and the secular traits that modify it — the behavior contract for the hero's inspiration system.
