...
## Purpose
Defines the documentation structure contract: a top-level `docs/README.md` index that maps every doc by area, area folders that group related docs, correct cross-references (in `AGENT.md` and within docs), correction of stale layout references, and the initial core-system documentation for world, battle, city/economy, hero/inventory, and magic.
