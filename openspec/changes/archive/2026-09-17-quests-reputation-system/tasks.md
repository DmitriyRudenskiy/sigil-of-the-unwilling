...
- [x] 3.1 Интеграция в `WorldPersistence.gd`: сохранение/загрузка состояния квестов и репутации
- [x] 3.2 Начальная репутация при создании героя (раса +10)

## 4. UI

- [x] 4.1 `scripts/ui/QuestJournalScreen.gd` — журнал: активные (прогресс), завершённые, проваленные; "Сдать квест" при выполнении
- [x] 4.2 `scripts/ui/FactionScreen.gd` — 6 фракций: значение, уровень, модификаторы, история изменений

## 5. Валидация

- [x] 5.1 Полный GdUnit4 run: все тесты зелёные
- [x] 5.2 MCP-регрессия: 27 passed
