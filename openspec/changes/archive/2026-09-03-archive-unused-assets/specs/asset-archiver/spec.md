...
Detects which assets under `game/assets/` are referenced by the game and moves only the confirmed-unused ones to `_archive`, with a manifest for rollback and a post-archive operability check.
