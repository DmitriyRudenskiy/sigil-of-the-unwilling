---
description: "Requirements for audio: music per scene, SFX on core actions, user-controlled volume, and graceful degradation when audio is missing or headless."
---
